  ...
  ios: [
    {
      ...
      note: "проще всего",
      recommended: true,
      scheme: (u) => `happ://add/${encodeURIComponent(u)}`,
      store: { ios: "https://apps.apple.com/app/happ-proxy-utility/id6504287215" },
    },
    {
      name: "V2RayTun",
      note: "популярный",
      scheme: (u) => `v2raytun://import/${encodeURIComponent(u)}`,
      store: { ios: "https://apps.apple.com/app/v2raytun/id6476628951" },
    },
    {
      name: "Streisand",
      note: "без рекламы",
      scheme: (u) => `streisand://import/${encodeURIComponent(u)}`,
      ...
      <ol className="connectp__steps">
        ...
        <li className="connectp__step">
          ...
          <p>
            ...
            «Подключить». Страну можно переключать прямо в приложении — если один сервер тормозит,
            выберите другой.
          </p>
        </li>
      </ol>
